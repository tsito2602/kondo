...
for (const size of [192, 512]) {
  ...
  await webPng(`public/icons/kondo-icon-v10-${size}.png`, webLight, size);
...
await webPng('public/icons/kondo-icon-v10-maskable-512.png', svg(.72), 512);
...
for (const file of ['public/icons/apple-touch-icon.png', 'public/apple-touch-icon.png', 'public/apple-touch-icon-v2.png', 'public/icons/kondo-apple-touch-icon.png', 'public/icons/kondo-apple-touch-icon-v10.png', 'public/apple-touch-icon-dark.png']) {
...
await writeFile('public/icons/kondo-icon-v10.svg', adaptiveIcon);
...
console.log('Exported journey-only kondo mark with white edging.');
