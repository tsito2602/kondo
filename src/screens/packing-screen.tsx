...
const createStyles = (palette: Palette) => StyleSheet.create({
  ...
  filterChip: { borderWidth: 1, borderColor: 'transparent', minHeight: 44, maxWidth: 220, justifyContent: 'center', paddingHorizontal: 16, borderRadius: 999, backgroundColor: palette.mist },
  ...
  sharedBadge: { overflow: 'hidden', color: palette.slate, backgroundColor: palette.sky, borderRadius: 5, paddingHorizontal: 6, paddingVertical: 2, fontSize: 11, fontWeight: '700' },
  sharedHint: { color: palette.slate, fontSize: 12, lineHeight: 18, marginTop: 8 },
  segmented: { flexDirection: 'row', backgroundColor: palette.mist, borderRadius: 14, padding: 4 },
  segment: { borderWidth: 1, borderColor: 'transparent', flex: 1, minHeight: 44, borderRadius: 10, alignItems: 'center', justifyContent: 'center' },
  segmentSelected: { backgroundColor: palette.selection, borderColor: palette.selectionBorder },
  ...
  progressFill: { height: '100%', minWidth: 0, backgroundColor: palette.slate, borderRadius: 999 },
  ...
  check: { width: 28, height: 28, borderRadius: 14, borderWidth: 2, borderColor: palette.smoke, alignItems: 'center', justifyContent: 'center' },
  checkDone: { backgroundColor: palette.slate, borderColor: palette.slate },
  checkText: { color: palette.canvas, fontSize: 16, lineHeight: 18, fontWeight: '900' },
  checkTextDone: { color: palette.canvas },
  ...
  miniCheck: { width: 22, height: 22, borderRadius: 7, borderWidth: 2, borderColor: palette.smoke, alignItems: 'center', justifyContent: 'center' },
  miniCheckSelected: { backgroundColor: palette.slate, borderColor: palette.slate },
  miniCheckText: { color: palette.canvas, fontSize: 12, lineHeight: 14, fontWeight: '900' },
  ...
  categoryButton: { borderWidth: 1, borderColor: 'transparent', backgroundColor: palette.mist, borderRadius: 999, paddingHorizontal: 14, paddingVertical: 10 },
  categorySelected: { backgroundColor: palette.selection, borderColor: palette.selectionBorder },
  categoryText: { color: palette.slate, fontSize: 13, lineHeight: 17, fontWeight: '700' },
  categoryTextSelected: { color: palette.ink },
  ...
  saveText: { color: palette.canvas, fontSize: 15, lineHeight: 19, fontWeight: '800' },
