...
const styles = StyleSheet.create({
  ...
  typeTag: { alignSelf: 'flex-start', backgroundColor: palette.mint, borderRadius: 64, paddingHorizontal: 10, paddingVertical: 5 },
  type: { color: palette.carbon, fontFamily: 'monospace', fontSize: 9, fontWeight: '400', letterSpacing: 0.8 },
  serial: { color: palette.smoke, fontFamily: 'monospace', fontSize: 9 },
  cardTitle: { color: palette.carbon, fontSize: 20, lineHeight: 23, fontWeight: '900', letterSpacing: -0.4, marginTop: 18 },
  ...
  stub: { width: 76, borderLeftWidth: 1, borderStyle: 'dashed', borderLeftColor: palette.ash, backgroundColor: palette.mist, alignItems: 'center', justifyContent: 'center' },
  icon: { color: palette.carbon, fontSize: 24, fontWeight: '900' },
  stubNo: { color: palette.carbon, fontSize: 24, lineHeight: 27, fontWeight: '900', marginTop: 12 },
