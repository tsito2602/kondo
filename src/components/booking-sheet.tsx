...
const createStyles = (palette: Palette) => StyleSheet.create({
  ...
  kindButton: { borderWidth: 1, borderColor: 'transparent', minHeight: 38, justifyContent: 'center', backgroundColor: palette.paper, borderRadius: 64, paddingHorizontal: 14 },
  kindSelected: { backgroundColor: palette.selection, borderColor: palette.selectionBorder },
  ...
  matchButtonSelected: { backgroundColor: palette.slate },
  matchButtonText: { color: palette.actionText, fontSize: 11, fontWeight: '800' },
  matchButtonTextSelected: { color: palette.canvas },
