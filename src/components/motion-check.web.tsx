...
export function MotionCheck({ checked }: { checked: boolean }) {
  ...
  return <svg aria-hidden="true" width="16" height="16" viewBox="0 0 12 12" style={{ color: palette.canvas }} data-checked={checked}><path ref={path} d="M2 6L4.7 8.7L10 3" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" /></svg>;
}
