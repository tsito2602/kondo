...
const createStyles = (palette: Palette) => StyleSheet.create({
  ...
  airportCode: { color: palette.actionText, fontSize: 27, fontWeight: '800' },
  ...
  duration: { color: palette.actionText, fontSize: 12, fontWeight: '700' },
  ...
  linkTitle: { color: palette.actionText, fontSize: 12, lineHeight: 18, fontWeight: '700' },
  linkDetail: { color: palette.slate, fontSize: 11, lineHeight: 17, marginTop: 3 },
  chevron: { color: palette.actionText, fontSize: 22 },
});
