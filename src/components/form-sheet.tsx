...
const createStyles = (palette: Palette) => StyleSheet.create({
  overlay: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: Platform.OS === 'web' ? 'rgba(24,42,54,0.2)' : palette.canvas, padding: Platform.OS === 'web' ? 16 : 0 },
  sheet: {
    width: '100%',
    flex: 1,
    maxWidth: 640,
  ...
  fill: { flex: 1 },
  header: { minHeight: 64, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 12, backgroundColor: palette.glass, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: palette.glassEdge },
  ...
  error: { padding: 14, borderRadius: 8, color: palette.danger, fontSize: 14, lineHeight: 21, backgroundColor: palette.glassStrong },
  confirmCard: {
    width: '100%',
    maxWidth: 360,
    padding: 24,
