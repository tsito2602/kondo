import { createContext, createElement, type PropsWithChildren, useCallback, useContext, useMemo, useRef, useState } from 'react';
...
export function ItineraryDraftProvider({ children }: PropsWithChildren) {
  ...
  return createElement(ItineraryTravelContext.Provider, { value }, children);
}
