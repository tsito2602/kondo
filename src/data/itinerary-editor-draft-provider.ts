...
import { ItineraryTravelContext, type ItineraryDraftControl, type ItineraryTravelValue, type TravelValue } from './itinerary-editor-draft';
...
const newDraftId = () => `draft-${++draftIdSequence}`;
...
export function ItineraryDraftProvider({ children }: PropsWithChildren) {
  ...
  return jsx(ItineraryTravelContext.Provider, { value, children });
}
